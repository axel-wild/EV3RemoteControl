...
public class EV3SensorService implements CatroidService, SharedPreferences.OnSharedPreferenceChangeListener {
	...
	public EV3Sensor createSensor1() {
		EV3Sensor.Sensor sensor = EV3Sensor.Sensor.getSensorFromSensorCode(EV3_SENSOR_1);
		return createSensor(sensor, 0);
	}

	public EV3Sensor createSensor2() {
		EV3Sensor.Sensor sensor = EV3Sensor.Sensor.getSensorFromSensorCode(EV3_SENSOR_2);
		return createSensor(sensor, 1);
	}

	public EV3Sensor createSensor3() {
		EV3Sensor.Sensor sensor = EV3Sensor.Sensor.getSensorFromSensorCode(EV3_SENSOR_3);
		return createSensor(sensor, 2);
	}

	public EV3Sensor createSensor4() {
		EV3Sensor.Sensor sensor = EV3Sensor.Sensor.getSensorFromSensorCode(EV3_SENSOR_4);
	...
	private boolean isChangedPreferenceASensorPreference(String preference) {
		return (preference.equals(EV3_SENSOR_1)
				|| preference.equals(EV3_SENSOR_2)
				|| preference.equals(EV3_SENSOR_3)
				|| preference.equals(EV3_SENSOR_4));
	}
